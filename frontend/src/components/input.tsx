            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
              <div className="bg-[#202222] p-4 rounded-lg">
                <div className="flex items-center mb-2">
                  <div className="w-6 h-6 rounded-full bg-gray-700 flex items-center justify-center text-xs mr-2">B</div>
              ...
              <div className="bg-[#202222] p-4 rounded-lg">
                <div className="flex items-center mb-2">
                  <div className="w-6 h-6 rounded-full bg-gray-700 flex items-center justify-center text-xs mr-2">R</div>
              ...
              <div className="bg-[#202222] p-4 rounded-lg">
                <div className="flex items-center mb-2">
                  <div className="w-6 h-6 rounded-full bg-gray-700 flex items-center justify-center text-xs mr-2">Y</div>
              ...
              <div className="max-w-[640px] w-full flex flex-row gap-10 items-center justify-between pt-1">
                ...
                <div className="max-w-[188px] w-full flex flex-row items-center justify-end">
                  <div className="group bg-none hover:bg-[#2d2f2f] transition-all duration-200 rounded-lg flex justify-center items-center max-w-[36px] w-full h-[32px] cursor-pointer">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#8d9191" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4 group-hover:stroke-white">
