...
const Input = () => {
  return (
    ...
    <section className="pt-[200px]">
        <div className="max-w-[766px] w-full items-center mx-auto flex flex-col gap-5">
            <h3 className="text-[28px] text-[#FFFFFF] font-semibold text-center">What can i halp with?</h3>

            <form action="" className="w-full">
                <textarea name="" id="" className="bg-[#303030] border border-[#fff3] rounded-3xl resize-none p-3 outline-none w-full h-[110px]" placeholder="Ask anything">
