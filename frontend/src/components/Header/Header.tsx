  ...
  return (
    <header className="sticky top-0 w-full bg-[#121212] text-white z-[1000] py-3 px-4 border-b border-gray-800 flex items-center justify-between">
      ...
      <div className="flex items-center space-x-1 sm:space-x-3">
        {/* Mobile View: Only theme toggle and mobile menu button visible */}
        <button
          className="p-2 rounded-full hover:bg-gray-700 transition duration-200 sm:hidden"
        ...
        {/* Desktop View: All buttons visible except the menu */}
        ...
        {/* More Options Dropdown (for mobile, archive and delete only) */}
          ...
          {isMobileMenuOpen && (
            <div className="absolute right-0 mt-2 w-36 rounded-md shadow-lg bg-gray-800 ring-1 ring-black ring-opacity-5 focus:outline-none">
              <div className="py-1" role="menu" aria-orientation="vertical" aria-labelledby="options-menu">
                ...
                {/* Archive and Delete options for mobile */}
                <button
                  className="px-4 py-2 text-sm text-gray-200 hover:bg-gray-700 w-full text-left flex items-center"
                  role="menuitem"
                >
        ...
        {/* Desktop View: Separate More Options (only Archive & Delete) */}
