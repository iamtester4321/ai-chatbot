...
export default function Header() {
  ...
  const [chatbotName] = useState("AI Assistant");
  ...
  return (
    <header className="sticky top-0 right-0 w-full bg-[#121212] dark:bg-[#121212] text-white z-10 py-3 px-4 border-b border-gray-800 flex items-center justify-end">
      {/* <div className="flex items-center">
        <h1 className="text-xl font-semibold truncate max-w-[200px] sm:max-w-xs">{chatbotName}</h1>
      </div> */}
