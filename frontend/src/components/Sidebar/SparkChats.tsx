  ...
  return (
    <div className="mb-4 w-full">
      <button
        ...
        className="flex items-center gap-5 px-2.5 py-2 text-sm w-full hover:bg-[var(--color-muted)] rounded-lg transition-all duration-200 text-[color:var(--color-text)] cursor-pointer"
      >
        {isShareOpen ? (
